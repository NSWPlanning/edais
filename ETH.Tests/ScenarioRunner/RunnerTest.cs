	...
	public class RunnerTest
	{
		public class Run
		{
			...
			public void FindsAndRunsScenario()
			{
				...
				runner.Run("moo", "DummyScenario.SomeScenario", new string[0]);
			...
			public void FailsWhenInvalidScenarioFormat()
			{
				...
				runner.Invoking(r => r.Run("moo", "DummyScenarioSomeScenario", new string[0]))
			...
			public void FailsWhenCantFindType()
			{
				...
				runner.Invoking(r => r.Run("moo", "DummyScenario.SomeScenario", new string[0]))
					  .ShouldThrow<InvalidOperationException>()
			...
			public void FailsWhenCantFindMethod()
			{
				...
				runner.Invoking(r => r.Run("moo", "DummyScenario.SomeOtherScenario", new string[0]))
					  .ShouldThrow<InvalidOperationException>()
