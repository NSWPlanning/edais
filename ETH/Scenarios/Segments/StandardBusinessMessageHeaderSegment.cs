...
namespace ETH.Scenarios
{
	public static class StandardBusinessMessageHeaderSegment
	{
		public static void RunCommonTests(this StandardBusinessMessageHeader header)
		{
			...
			TestPartner(header.ReceiverPartner, false);
			TestPartner(header.SenderPartner, false);
		}

        public static void RunFullPartnerTests(this StandardBusinessMessageHeader header)
        {
            TestPartner(header.ReceiverPartner, true);
            TestPartner(header.SenderPartner, true);
        }

		static void TestPartner(Partner partner, bool checkContact)
		{
